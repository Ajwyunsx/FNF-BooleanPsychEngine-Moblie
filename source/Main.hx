...
class Main extends Sprite
{
	...
	function onCrash(e:UncaughtErrorEvent):Void
	{
		...
		path = "./crash/" + "BooleanPsychEngine_" + dateNow + ".txt";
		...
		//错误信息
		//引擎改了这么多出bug你不能还推给原作者吧，这太不道德了~
		errMsg += "\nUncaught Error: " + e.error + "\nPlease report to me by surfing : \nhttps://space.bilibili.com/477171840?spm_id_from=333.1007.0.0\nKevin7501 in Bilibili\n> Crash Handler written by: sqirra-rng";
