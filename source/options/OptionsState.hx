package options;
//option菜单界面
import options.BoolPESetting.BoolPESettingsSubState;
#if desktop
...
{
	var options:Array<String> = ['BoolPE Setting','Note Colors', 'Controls', 'Adjust Delay and Combo', 'Graphics', 'Visuals and UI', 'Gameplay'];
	...
	function openSelectedSubstate(label:String) {
		switch(label) {
			case 'BoolPE Setting':
				...
				removeVirtualPad();
				#end
				openSubState(new BoolPESettingsSubState());
			case 'Note Colors':
				#if android
				removeVirtualPad();
				#end
